...
//	private Coordinate ActionGeoLocation;
//	
	...
	public static CoalesceRecordset createRecordSet(CoalesceSection section, String pathName) {
		...
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.GlobalEventID, ECoalesceFieldDataTypes.INTEGER_TYPE);
		...
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.IsRootEvent, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.EventCode, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.EventBaseCode, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.EventRootCode, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.QuadClass, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.GoldsteinScale, ECoalesceFieldDataTypes.FLOAT_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.NumMentions, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.NumSources, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.NumArticles, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.AvgTone, ECoalesceFieldDataTypes.FLOAT_TYPE);

		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoType, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoFullname, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoCountryCode, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoADM1Code, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoADM2Code, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoFeatureID, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.DateAdded, ECoalesceFieldDataTypes.INTEGER_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.SourceURL, ECoalesceFieldDataTypes.STRING_TYPE);
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.DateTime, ECoalesceFieldDataTypes.DATE_TIME_TYPE);
		
		CoalesceFieldDefinition.create(eventRecordSet, GDELTEventConstants.ActionGeoLocation,
	...
	public int getDateAdded() {
		try {
			return ((CoalesceIntegerField) this.getFieldByName(GDELTEventConstants.DateAdded)).getValue();
		} catch (CoalesceDataFormatException e) {
			LOGGER.error(e.getMessage(),e);
			return 0;
		}	
	...
	public void setDateAdded(int dateAdded) {
		((CoalesceIntegerField) this.getFieldByName(GDELTEventConstants.DateAdded)).setValue(dateAdded);
	}
	...
	public DateTime getDateTime() {
		try {
			return ((CoalesceDateTimeField) this.getFieldByName(GDELTEventConstants.DateTime)).getValue();
		} catch (CoalesceDataFormatException e) {
			LOGGER.error(e.getMessage(),e);
	...
	public void setDateTime(DateTime dateTime) {
		((CoalesceDateTimeField) this.getFieldByName(GDELTEventConstants.DateTime)).setValue(dateTime);
	}
