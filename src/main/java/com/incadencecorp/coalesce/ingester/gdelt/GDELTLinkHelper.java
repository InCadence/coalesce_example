 ...
 * together.
 */
public final class GDELTLinkHelper {

    // ----------------------------------------------------------------------//
    // Private and protected Objects
    // ----------------------------------------------------------------------//

    private static final String MODULE_NAME = GDELTLinkHelper.class.getName();
    private static final Logger LOGGER = LoggerFactory.getLogger(GDELTLinkHelper.class);
   ...
   /**
     * Links two entities together bi-directionally with a default Unclassified classification
    ...
    /**
     * Links two entities together bi-directionally. If <code>updateExisting</code> is
     * <code>true</code> then the first linkage found between the two entities
     * with the same
     * {@link com.incadencecorp.coalesce.framework.datamodel.ELinkTypes} will be
     * updated instead of creating a new linkage.
        ...
        for (ICoalesceObject cdo : linkageSection.getChildCoalesceObjects().values())
        {
            if (cdo instanceof CoalesceLinkage)
            {
                ...
                if (childLinkage.getEntity1Key().equals(entity.getKey()) 
                        ...
                        && childLinkage.getLabel().equalsIgnoreCase(label))
                {
